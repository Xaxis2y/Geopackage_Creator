...
class GeoPackageConverter:
    ...
    def convert(
        ...
        try:
            ...
            #   * sets application_id to the OGC/DGIWG 'GP14' marker (0x47503134)
    ...
    def _finalize_dgiwg_compliance(self, gpkg_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # 7) Set the OGC/DGIWG 'GP14' application_id (0x47503134) and user_version (10400) so the file
            # self-declares as GeoPackage 1.4 (DGIWG Req 3).
            try:
                cur.execute(
