...
# ======================
# PyInstaller spec for GeoPackage Creator v0.30.19
#
...
# ---------------------------------------------------------------------------
# DGIWG_GeoPackage_Validator_v1.58 (v0.30.17 - was DGIWG_Validator_v1_55_updated
...
# discovery (base / "DGIWG_GeoPackage_Validator_v1.58") find it unchanged
...
app_datas = [
    ...
    (str(ROOT / "DGIWG_GeoPackage_Validator_v1.58"),     "DGIWG_GeoPackage_Validator_v1.58"),
...
hidden = [
    ...
    *collect_submodules("ttkbootstrap"),
    ...
    # DGIWG_GeoPackage_Validator_v1.58/) is deliberately NOT listed here.
