...
**Version 0.27.0** | June 11, 2026 | OGC GeoPackage 1.4 & DGIWG Compliant
...
├── geopackage_creator_gui.py    # Graphical interface (tkinter)
...
├── CHANGELOG_v0.26.md           # Current release notes
...
- Python 3.8+
- GDAL ≥ 3.6 with Python bindings (`osgeo`) — see `GDAL_INSTALLATION.txt`
...
See **USER_MANUAL** for full documentation and **QUICKSTART.md** for a 5-minute walkthrough.
...
validator — see `CHANGELOG_v0.26.2.md` and `HANDOFF_NOTES_2026-06-10.md`.

## Version

**Current:** v0.27.0 — see `CHANGELOG_v0.27.md` and `VERSION.txt`
