"""Minimal v0.34 release update for docs/USER_MANUAL.docx."""
...
REPLACEMENTS = {
    2: "Version 0.34.0  |  August 17, 2026",
    16: "The tool requires Python 3.8 or newer and GDAL 3.6 or newer with Python bindings. ISO 19115 metadata validation and DGIWG validation run in isolated helper processes so GDAL and lxml/libxml2 do not share native process state. Reportlab is used for PDF reports, and tkinter is included with most Python installations for the GUI.",
