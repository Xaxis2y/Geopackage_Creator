...
class TestDomainFieldConversion:
    ...
    def test_multiple_domain_types(self, sample_geodatabase_with_domains, temp_dir):
        ...
        result = converter.convert(
            ...
            security="UNCLASSIFIED",
            language="eng",
            # v0.30.20: was "utilities", which is NOT a member of the ISO 19115
            # MD_TopicCategoryCode codelist - the correct value is
            # "utilitiesCommunication". core/config.py's TOPIC_CATEGORIES was
            # right and this test was wrong; it asserted result['success'] while
            # feeding in a value the validator is required to reject.
