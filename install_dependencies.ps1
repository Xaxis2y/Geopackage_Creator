...
Write-Host "[1/3] Installing Python packages..." -ForegroundColor Green
...
# Step 2: Try to install GDAL via conda first (if available)
Write-Host "[2/3] Installing GDAL..." -ForegroundColor Green
...
Write-Host "   conda install -c conda-forge gdal" -ForegroundColor White
Write-Host ""
