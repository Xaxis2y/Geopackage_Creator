...
**Version 0.33.44 | August 17, 2026**
...
>
> **v0.33.44 validates metadata in an isolated helper process.** GDAL and
> lxml/libxml2 no longer share the conversion process, avoiding the native
> access violation seen during repeated conversions. Install both through the
> supplied conda environment for the tested configuration.
> ```bash
