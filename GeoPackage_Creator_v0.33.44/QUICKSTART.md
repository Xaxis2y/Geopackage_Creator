# GeoPackage Creator - Quick Start Guide (v0.33.44)
...
2. Select your FileGDB folder (a `.gdb` suffix is optional when the folder contains `GEODATABASE_FILE_*`)
...
For detailed API reference, see: `docs/USER_MANUAL.docx`
...
**GeoPackage Creator v0.33.44** | OGC 1.4 & DGIWG Compliant | August 17, 2026
