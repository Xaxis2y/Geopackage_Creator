...
| `GeoPackageCreator-Setup-0.30.19.exe` | Classic `Setup.exe` installer | End users — installs to Program Files, adds Start Menu + Desktop shortcuts, includes an uninstaller |
...
2. The installer appears at
   `packaging\installer\Output\GeoPackageCreator-Setup-0.30.19.exe`.
