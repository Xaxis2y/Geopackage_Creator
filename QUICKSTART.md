# GeoPackage Creator - Quick Start Guide (v0.26)
...
Then:
1. Click "Browse..." next to "Source .gdb"
2. Select your .gdb folder (click once, don't double-click)
...
For detailed API reference, see: `GeoPackage_Creator_User_Manual_v0.26.docx`
...
**GeoPackage Creator v0.26.0** | OGC 1.4 & DGIWG Compliant | June 9, 2026
