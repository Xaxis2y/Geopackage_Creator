...
"""Per-file HTML report rendering for the DGIWG validator (v1.62)."""
import os
import sys
import html
import json
...
def render_html(
    ...
    # v1.62 fix: filter requirement rows by key TYPE (int) rather than by a
    ...
    # ── v1.62: conformance-scope banner ──────────────────────────────────────
...
<div class="content">
  ...
  <div class="legend">
    ...
    <span class="legend-item"><span class="legend-dot" style="background:#8e44ad;"></span> ERROR — Validator could not complete this check; do not treat as a data failure</span>
...
<div class="footer">
  ...
  <div style="margin-top:2px;font-size:11px;color:#7f8c8d !important;">&copy; MCE/T&amp;E &mdash; Mapping and Charting Establishment / Geomatics Engineering Trials &amp; Evaluation Support Section (GETESS)</div>
    ...
    with open(output_path, "w", encoding="utf-8") as f:
        f.write(html_str)
    # v1.62 fix: honour --quiet.  This line printed unconditionally, so
