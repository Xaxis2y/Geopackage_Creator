...
**Version 0.34.1** | August 19, 2026 | OGC GeoPackage 1.4 & DGIWG Compliant
...
v0.34.1 retains the v0.34.0 isolation of both ISO metadata schema validation and bundled DGIWG v1.62
